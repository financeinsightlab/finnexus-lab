...
_gcur = "pbi"
_nav_groups = {"pbi": [], "excel": [], "pq": [], "sql": [], "tb": [], "py": [], "st": [], "viz": [], "ts": [], "eng1": [], "eng2": [], "eng3": [], "eng4": [], "eng5": [], "eng6": [], "eng7": [], "eng8": [], "eng9": [], "eng10": [], "eng11": [], "avg": [], "blood": [], "di": [], "pct": [], "lr": [], "ns": [], "pp": [], "pb": [], "pl": [], "ra": [], "si": [], "sy": [], "sd": [], "tw": [], "ac": [], "cf": [], "bf": [], "dv": [], "fa": [], "fi": [], "in2": [], "ec": [], "pm": [], "rt": [], "tv": []}
_nav_counts = {"pbi": 0, "excel": 0, "pq": 0, "sql": 0, "tb": 0, "py": 0, "st": 0, "viz": 0, "ts": 0, "eng1": 0, "eng2": 0, "eng3": 0, "eng4": 0, "eng5": 0, "eng6": 0, "eng7": 0, "eng8": 0, "eng9": 0, "eng10": 0, "eng11": 0, "avg": 0, "blood": 0, "di": 0, "pct": 0, "lr": 0, "ns": 0, "pp": 0, "pb": 0, "pl": 0, "ra": 0, "si": 0, "sy": 0, "sd": 0, "tw": 0, "ac": 0, "cf": 0, "bf": 0, "dv": 0, "fa": 0, "fi": 0, "in2": 0, "ec": 0, "pm": 0, "rt": 0, "tv": 0}
RAW_MD = {}
...
<div class="hero">
 ...
 <div class="hero-in">
  ...
  <p>Four umbrellas now — 🎓 <b>BUSINESS ANALYTICS</b> (9 courses: Power BI · Excel · Power Query · SQL · Tableau · Python · Statistics · Data Viz · Time Series) · 🗣️ <b>ENGLISH</b> (11 courses: Basic to Fluency) · 🧮 <b>APTITUDE</b> (Averages · Blood Relations · DI · Percentages · LR Puzzles · Number Series · Permutations & Combinations · Probability · Profit & Loss · Ratio & Proportion · Simple & Compound Interest · Syllogisms · Time Speed & Distance · NEW! ⏱️ Time & Work) · 💼 <b>FINANCE CORE</b> (NEW! 📒 Accounting · 🏦 Corporate Finance · 🧠 Behavioural Finance · 📉 Derivatives · 📊 Financial Statement Analysis · 🛡️ Fixed Income · 🇮🇳 Indian Market · 🌍 Economics · 🧺 Portfolio Management · 🔍 Ratio Analysis · ⏳ Time Value of Money — from journal entries to the ratio room and the desk that prices time itself!) — every track basic→advanced, finance-flavored · 864 auto-graded quiz questions · ShopKart retail + Finance GL + a real SQLite practice DB ·
...
<div id="certWrap"><div class="cert">
 ...
 288 sections across 45 courses: Power BI, Excel, Power Query, SQL, Tableau, Python, Statistics, Data Visualization, Time Series, Basic English, Business News Speaking, Business Vocabulary, Email Writing, Interview Grammar, Reading Practice, Group Discussion, Interview Communication, Pronunciation Lab, Self-Introduction Speaking, Spoken Fluency, Averages, Blood Relations, Data Interpretation, Percentages, Logical Reasoning Puzzles, Number Series, Permutations & Combinations, Probability, Profit & Loss, Ratio & Proportion, Simple & Compound Interest, Syllogisms, Time Speed & Distance, Time & Work, Accounting, Corporate Finance, Behavioural Finance, Derivatives, Financial Statement Analysis, Fixed Income, Indian Market, Economics, Portfolio Management, Ratio Analysis & Time Value of Money (incl. advanced + finance),<br>
