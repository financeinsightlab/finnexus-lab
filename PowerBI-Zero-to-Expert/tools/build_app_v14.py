...
OUT = os.path.join(BASE, "PowerBI_Course_App_v14.html")
...
# track-ordered master list: PBI, Excel (+x6), PQ (+p5), SQL, Tableau, Python, Statistics, DataViz, TimeSeries
FIN_PBI = FIN_SECTIONS[0:1]; FIN_XL = FIN_SECTIONS[1:2]; FIN_PQ = FIN_SECTIONS[2:3]
ALL_SECTIONS = SECTIONS + FIN_PBI + EXCEL_SECTIONS + FIN_XL + PQ_SECTIONS + FIN_PQ + SQL_SECTIONS + TABLEAU_SECTIONS + PYTHON_SECTIONS + STATS_SECTIONS + VIZ_SECTIONS + TS_SECTIONS
...
_gcur = "pbi"
_nav_groups = {"pbi": [], "excel": [], "pq": [], "sql": [], "tb": [], "py": [], "st": [], "viz": [], "ts": []}
_nav_counts = {"pbi": 0, "excel": 0, "pq": 0, "sql": 0, "tb": 0, "py": 0, "st": 0, "viz": 0, "ts": 0}
RAW_MD = {}
...
<div class="hero">
 ...
 <div class="hero-in">
  <div class="kicker">🎓 BUSINESS ANALYTICS ACADEMY · SELF-PACED · OFFLINE</div>
  <h1>Business Analytics<br><span>Zero → World-Class Expert</span></h1>
  <p>One umbrella — <b>Business Analytics</b>: Power BI + Excel + Power Query + SQL + Tableau + Python + Statistics + Data Visualization + Time Series (basic→advanced) tracks, each with a FINANCE specialization · 177 auto-graded quiz questions · ShopKart retail + Finance GL + a real SQLite practice DB ·
...
<div class="stats">
 <div class="stat"><b data-count="59">0</b><span>Sections</span></div>
 <div class="stat"><b data-count="55">0</b><span>Hands-on labs</span></div>
 <div class="stat"><b data-count="177">0</b><span>Quiz questions</span></div>
...
_ba_total = sum(_nav_counts.values())
nav_html = (
    '<li class="navmega-li"><details class="navmega" open>'
    '<summary class="navmegah"><span class="megatitle">🎓 Business Analytics</span>'
    '<span class="megacount">%d courses · %d sections</span><span class="ddarrow">▾</span></summary>'
    '<ul class="megalist">%s</ul></details></li>'
    % (len(GROUP_META), _ba_total, "\n".join(_dd))
)
...
<title>Business Analytics Academy · Zero → Expert</title>
...
<header>
 ...
 <div class="brand"><span class="dot"></span>Business Analytics Academy</div>
...
<div id="certWrap"><div class="cert">
 ...
 <p>has completed the full <b>Business Analytics: Zero → World-Class Expert</b> program —<br>
 59 sections across 9 courses: Power BI, Excel, Power Query, SQL, Tableau, Python, Statistics, Data Visualization & Time Series (incl. advanced + finance), Data Modeling,<br>
 DAX, finance dashboards, forecasting, Service, Performance & capstones — the complete data-analyst stack.</p>
