...
OUT = os.path.join(BASE, "PowerBI_Course_App_v5.html")
...
RADIOS = "\n".join(
    ...
    + ['<input class="tabr" type="radio" name="tabc" id="r-%s">' % sid for _, sid, _, _, _ in SECTIONS + EXCEL_SECTIONS]
)
...
for _sid in ["home"] + [sid for _, sid, _, _, _ in SECTIONS + EXCEL_SECTIONS]:
...
ALL_SECTIONS = SECTIONS + EXCEL_SECTIONS
...
<div class="hero">
 ...
 <div class="hero-in">
  ...
  <p>12 Power BI modules + 5-level Excel track · 51 auto-graded quiz questions · a 1,300-row Indian retail dataset (ShopKart) ·
...
<div class="stats">
 <div class="stat"><b data-count="17">0</b><span>Sections</span></div>
 <div class="stat"><b data-count="25">0</b><span>Hands-on labs</span></div>
 <div class="stat"><b data-count="51">0</b><span>Quiz questions</span></div>
...
function onTab(){syncUI(currentId())}
...
<div id="certWrap"><div class="cert">
 ...
 17 sections covering Excel mastery, Power Query, Data Modeling, DAX, Visualization,<br>
 Power BI Service, Performance Engineering and 3 portfolio capstone projects.</p>
