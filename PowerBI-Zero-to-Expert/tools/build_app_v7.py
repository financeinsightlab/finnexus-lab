...
OUT = os.path.join(BASE, "PowerBI_Course_App_v7.html")
...
ALL_SECTIONS = SECTIONS + FIN_PBI + EXCEL_SECTIONS + FIN_XL + PQ_SECTIONS + FIN_PQ
...
<div class="hero">
 ...
 <div class="hero-in">
  ...
  <p>Full Power BI + Excel + Power Query tracks, each with a FINANCE specialization (P&L, loans, fiscal years) · 72 auto-graded quiz questions · ShopKart India + Finance GL datasets ·
...
<div class="stats">
 <div class="stat"><b data-count="24">0</b><span>Sections</span></div>
 <div class="stat"><b data-count="25">0</b><span>Hands-on labs</span></div>
 <div class="stat"><b data-count="72">0</b><span>Quiz questions</span></div>
...
<div id="certWrap"><div class="cert">
 ...
 24 sections covering Excel & Excel-for-Finance, Power Query + M + Finance ETL,<br>
 Data Modeling, DAX, Finance dashboards (P&L/variance), Service, Performance & capstones.</p>
