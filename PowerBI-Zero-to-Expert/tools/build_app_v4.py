...
OUT = os.path.join(BASE, "PowerBI_Course_App_v4.html")
...
RADIOS = "\n".join(
    ...
    + ['<input class="tabr" type="radio" name="tabc" id="r-%s">' % sid for _, sid, _, _, _ in SECTIONS]
)
...
for _sid in ["home"] + [sid for _, sid, _, _, _ in SECTIONS]:
