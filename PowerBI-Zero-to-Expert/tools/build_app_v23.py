...
OUT = os.path.join(BASE, "PowerBI_Course_App_v23.html")
...
# track-ordered master list: Business Analytics (9 tracks) then English umbrella (Basic, News, Vocabulary, Email, Grammar, Reading, Group Discussion, Interview Communication)
FIN_PBI = FIN_SECTIONS[0:1]; FIN_XL = FIN_SECTIONS[1:2]; FIN_PQ = FIN_SECTIONS[2:3]
ALL_SECTIONS = SECTIONS + FIN_PBI + EXCEL_SECTIONS + FIN_XL + PQ_SECTIONS + FIN_PQ + SQL_SECTIONS + TABLEAU_SECTIONS + PYTHON_SECTIONS + STATS_SECTIONS + VIZ_SECTIONS + TS_SECTIONS + EN1_SECTIONS + BNS_SECTIONS + VOCAB_SECTIONS + EMAIL_SECTIONS + GRAMMAR_SECTIONS + READING_SECTIONS + GD_SECTIONS + IC_SECTIONS
...
_gcur = "pbi"
_nav_groups = {"pbi": [], "excel": [], "pq": [], "sql": [], "tb": [], "py": [], "st": [], "viz": [], "ts": [], "eng1": [], "eng2": [], "eng3": [], "eng4": [], "eng5": [], "eng6": [], "eng7": [], "eng8": []}
_nav_counts = {"pbi": 0, "excel": 0, "pq": 0, "sql": 0, "tb": 0, "py": 0, "st": 0, "viz": 0, "ts": 0, "eng1": 0, "eng2": 0, "eng3": 0, "eng4": 0, "eng5": 0, "eng6": 0, "eng7": 0, "eng8": 0}
RAW_MD = {}
...
<div class="hero">
 ...
 <div class="hero-in">
  ...
  <p>Two umbrellas today — 🎓 <b>BUSINESS ANALYTICS</b> (9 courses: Power BI · Excel · Power Query · SQL · Tableau · Python · Statistics · Data Viz · Time Series) and 🗣️ <b>ENGLISH</b> (Basic English + 🗞️ News Speaking + 📖 Vocabulary + ✉️ Email Writing + 📝 Interview Grammar + 📚 Reading Practice + 👥 Group Discussion + 🎤 Interview Communication) — every track basic→advanced, finance-flavored · 300 auto-graded quiz questions · ShopKart retail + Finance GL + a real SQLite practice DB ·
  3 portfolio projects · PL-300 certification plan · 🎧 18 embedded audio clips — press play anywhere, fully offline. Your progress, streaks and notes save automatically.</p>
  <div class="hero-act">
...
<div class="stats">
 <div class="stat"><b data-count="100">0</b><span>Sections</span></div>
 <div class="stat"><b data-count="96">0</b><span>Hands-on labs</span></div>
 <div class="stat"><b data-count="300">0</b><span>Quiz questions</span></div>
...
<div id="certWrap"><div class="cert">
 ...
 100 sections across 17 courses: Power BI, Excel, Power Query, SQL, Tableau, Python, Statistics, Data Visualization, Time Series, Basic English, Business News Speaking, Business Vocabulary, Email Writing, Interview Grammar, Reading Practice, Group Discussion & Interview Communication (incl. advanced + finance),<br>
