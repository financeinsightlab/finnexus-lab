...
OUT = os.path.join(BASE, "PowerBI_Course_App_v8.html")
...
# track-ordered master list: PBI group (incl roadmap..res, then m10), Excel group (+x6), PQ group (+p5)
FIN_PBI = FIN_SECTIONS[0:1]; FIN_XL = FIN_SECTIONS[1:2]; FIN_PQ = FIN_SECTIONS[2:3]
ALL_SECTIONS = SECTIONS + FIN_PBI + EXCEL_SECTIONS + FIN_XL + PQ_SECTIONS + FIN_PQ + SQL_SECTIONS
...
for idx, (fname, sid, label, icon, desc) in enumerate(ALL_SECTIONS):
    ...
    if sid == "s1":
        nav_items.append('<li class="navgroup">🗄️ SQL TRACK</li>')
    nav_items.append(
...
<div class="hero">
 ...
 <div class="hero-in">
  ...
  <p>Full Power BI + Excel + Power Query + SQL (basic→advanced) tracks, each with a FINANCE specialization · 87 auto-graded quiz questions · ShopKart retail + Finance GL + a real SQLite practice DB ·
...
<div class="stats">
 <div class="stat"><b data-count="29">0</b><span>Sections</span></div>
 <div class="stat"><b data-count="25">0</b><span>Hands-on labs</span></div>
 <div class="stat"><b data-count="87">0</b><span>Quiz questions</span></div>
...
<div id="certWrap"><div class="cert">
 ...
 29 sections covering Excel, Power Query, SQL (incl. advanced + finance), Data Modeling,<br>
