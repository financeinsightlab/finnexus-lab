...
OUT = os.path.join(BASE, "PowerBI_Course_App_v13.html")
...
# track-ordered master list: PBI, Excel (+x6), PQ (+p5), SQL, Tableau, Python, Statistics, DataViz
FIN_PBI = FIN_SECTIONS[0:1]; FIN_XL = FIN_SECTIONS[1:2]; FIN_PQ = FIN_SECTIONS[2:3]
ALL_SECTIONS = SECTIONS + FIN_PBI + EXCEL_SECTIONS + FIN_XL + PQ_SECTIONS + FIN_PQ + SQL_SECTIONS + TABLEAU_SECTIONS + PYTHON_SECTIONS + STATS_SECTIONS + VIZ_SECTIONS
...
_gcur = "pbi"
_nav_groups = {"pbi": [], "excel": [], "pq": [], "sql": [], "tb": [], "py": [], "st": [], "viz": []}
_nav_counts = {"pbi": 0, "excel": 0, "pq": 0, "sql": 0, "tb": 0, "py": 0, "st": 0, "viz": 0}
RAW_MD = {}
...
<div class="hero">
 ...
 <div class="hero-in">
  ...
  <p>Full Power BI + Excel + Power Query + SQL + Tableau + Python + Statistics + Data Visualization (basic→advanced) tracks, each with a FINANCE specialization · 159 auto-graded quiz questions · ShopKart retail + Finance GL + a real SQLite practice DB ·
...
<div class="stats">
 <div class="stat"><b data-count="53">0</b><span>Sections</span></div>
 <div class="stat"><b data-count="49">0</b><span>Hands-on labs</span></div>
 <div class="stat"><b data-count="159">0</b><span>Quiz questions</span></div>
...
<div id="certWrap"><div class="cert">
 ...
 53 sections covering Excel, Power Query, SQL, Tableau, Python, Statistics & Data Visualization (incl. advanced + finance), Data Modeling,<br>
