    ...
    <div className="min-h-screen py-10 relative">
      <div className="wrap max-w-7xl mx-auto">
        ...
        <div className="mb-6">
           ...
           <h1 className="text-3xl font-bold text-brand-navy dark:text-white">Comparable Company Analysis (CCA)</h1>
           <p className="text-brand-slate dark:text-slate-300">Mathematically value a private target company against public market trading multiples.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-8 relative">
          ...
          <div className="lg:col-span-1 space-y-6 bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 h-fit sticky top-24 z-20">
            <h3 className="font-bold text-brand-navy dark:text-white border-b pb-4">Financial Inputs (in Millions)</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                     ...
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerAMc} onChange={e => setPeerAMc(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">Net Debt</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerADebt} onChange={e => setPeerADebt(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">Revenue</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerARev} onChange={e => setPeerARev(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">EBITDA</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerAEbitda} onChange={e => setPeerAEbitda(Number(e.target.value))} />
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">Mkt Cap</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerBMc} onChange={e => setPeerBMc(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">Net Debt</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerBDebt} onChange={e => setPeerBDebt(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">Revenue</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerBRev} onChange={e => setPeerBRev(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">EBITDA</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerBEbitda} onChange={e => setPeerBEbitda(Number(e.target.value))} />
                  </div>
                </div>
              </div>
              ...
              <div className="pt-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">Mkt Cap</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerCMc} onChange={e => setPeerCMc(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">Net Debt</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerCDebt} onChange={e => setPeerCDebt(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">Revenue</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerCRev} onChange={e => setPeerCRev(Number(e.target.value))} />
                  </div>
                  <div>
                     <label className="block text-[10px] text-gray-500 uppercase">EBITDA</label>
                     <input type="number" className="input w-full py-1 text-sm bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white" value={peerCEbitda} onChange={e => setPeerCEbitda(Number(e.target.value))} />
                  </div>
                </div>
              </div>
          ...
          <div className={`lg:col-span-3 space-y-8 ${isLocked ? 'blur-md pointer-events-none select-none opacity-40' : ''} transition-all duration-700`}>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-3xl font-bold text-brand-navy dark:text-white">${Math.round(calculations.discountedEv).toLocaleString()}M</h4>
                  <p className="text-xs text-brand-slate dark:text-slate-300 mt-2">Target valuation derived from median multiples (discounted by {privateDiscount}%).</p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className={`text-3xl font-bold ${calculations.impliedEquityValue > 0 ? 'text-brand-navy dark:text-white' : 'text-red-500'}`}>
                    ${Math.round(calculations.impliedEquityValue).toLocaleString()}M
                  </h4>
                  <p className="text-xs text-brand-slate dark:text-slate-300 mt-2">Cash left for Founders/Sponsors after sweeping $M Net Debt.</p>
                </div>
              </div>

              <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group flex flex-col justify-center align-middle">
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 relative z-10">
              <h3 className="font-bold text-brand-navy dark:text-white mb-6">Trading Multiple Benchmarks (Target vs Competitors)</h3>
                  ...
                  <tbody className="text-gray-800">
                    ...
                    {calculations.excelComps.map((comp, idx) => (
                      <tr key={idx} className="hover:bg-blue-50/30 group">
                        ...
                        <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 bg-white dark:bg-slate-900 text-gray-700 pl-3 sticky left-6 z-20 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] group-hover:bg-blue-50/0">{comp.name}</td>
                        <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono">${comp.mc.toLocaleString()}</td>
                        <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono">${comp.debt.toLocaleString()}</td>
                        <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono font-bold">${comp.ev.toLocaleString()}</td>
                        <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white/50">${comp.rev.toLocaleString()}</td>
                        <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white/50">${comp.ebitda.toLocaleString()}</td>
                        <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono font-bold text-teal-700 bg-teal-50/30">{comp.evRev.toFixed(2)}x</td>
                        <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono font-bold text-teal-700 bg-teal-50/30">{comp.evEbitda.toFixed(2)}x</td>
                      </tr>
                    ))}

                    <tr>
                      <ExcelRowIndex i="4" />
                      <td colSpan={8} className="border border-gray-200 dark:border-slate-700 bg-gray-100/50 py-1 sticky left-6 z-20"></td>
                    </tr>

                    {/* Means and Medians */}
                    <tr className="bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white/80">
                      <ExcelRowIndex i="5" />
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 font-bold text-gray-500 pl-3 sticky left-6 z-20">Peer Group MEAN (Average)</td>
                      <td colSpan={5} className="border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white/80"></td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono font-bold text-gray-600">{calculations.meanEvRev.toFixed(2)}x</td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono font-bold text-gray-600">{calculations.meanEvEbitda.toFixed(2)}x</td>
                    </tr>

                    <tr className="bg-blue-50/20">
                      <ExcelRowIndex i="6" />
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 font-bold text-blue-900 pl-3 sticky left-6 z-20 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]">Peer Group MEDIAN</td>
                      <td colSpan={5} className="border border-gray-200 dark:border-slate-700"></td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono font-bold text-blue-700 bg-blue-50/50 border-2 border-blue-400 shadow-sm">{calculations.medianEvRev.toFixed(2)}x</td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono font-bold text-blue-700 bg-blue-50/50 border-2 border-blue-400 shadow-sm">{calculations.medianEvEbitda.toFixed(2)}x</td>
                    </tr>
                    ...
                    <tr className="hover:bg-blue-50/30 group/target">
                      <ExcelRowIndex i="8" />
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 font-bold bg-white dark:bg-slate-900 text-brand-navy dark:text-white pl-3 sticky left-6 z-20 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] uppercase">Target Subject Company Bridge</td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white/50 text-center font-mono text-gray-400 text-[9px] uppercase">Implied EV</td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white/50 text-center font-mono text-gray-400 text-[9px] uppercase">Your Input</td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 bg-gray-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white/50 text-center font-mono text-gray-400 text-[9px] uppercase">Implied Equity</td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono bg-yellow-50 font-bold border-t-2 border-t-brand-navy">${targetRev.toLocaleString()}</td>
                      <td className="border border-gray-200 dark:border-slate-700 px-2 py-2 text-right font-mono bg-yellow-50 font-bold border-t-2 border-t-brand-navy">${targetEbitda.toLocaleString()}</td>
        ...
        <div className="mt-16 bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-gray-100">
          <h2 className="text-2xl font-bold text-brand-navy dark:text-white mb-6">Trading Comps Glossary & Math</h2>
          <p className="text-brand-slate dark:text-slate-300 mb-8">Understanding the complex mechanics of Investment Banking Valuation Multiples.</p>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-2">
              <h4 className="font-bold text-brand-navy dark:text-white text-lg flex items-center gap-2"><span className="text-2xl">💰</span> Enterprise Value (EV)</h4>
              <p className="text-sm text-brand-slate dark:text-slate-300 leading-relaxed"><strong>What it is:</strong> The absolute total value of the operations of the business regardless of how it is financed. It is calculated as Market Capitalization (Shares x Price) PLUS Net Debt.</p>
            </div>

            <div className="space-y-2">
              <h4 className="font-bold text-brand-navy dark:text-white text-lg flex items-center gap-2"><span className="text-2xl">⚖️</span> Net Debt</h4>
              <p className="text-sm text-brand-slate dark:text-slate-300 leading-relaxed"><strong>What it is:</strong> Total Long and Short-term Debt minus Total Cash and Cash Equivalents. When you buy a house for $500k but assume a $100k mortgage, the Equity Value is only $400k. The exact same logic applies to acquiring companies.</p>
            </div>

            <div className="space-y-2">
              <h4 className="font-bold text-brand-navy dark:text-white text-lg flex items-center gap-2"><span className="text-2xl">📉</span> Private Company Discount</h4>
              <p className="text-sm text-brand-slate dark:text-slate-300 leading-relaxed"><strong>What it is:</strong> Also called an Illiquidity Discount. A public stock can be sold on the NASDAQ in 5 seconds. A private company might take 9 months to sell. Buyers demand a 15-30% discount on Valuation to compensate for this severe lack of liquidity.</p>
            </div>

            <div className="space-y-2">
              <h4 className="font-bold text-brand-navy dark:text-white text-lg flex items-center gap-2"><span className="text-2xl">📊</span> Why use the Median?</h4>
              <p className="text-sm text-brand-slate dark:text-slate-300 leading-relaxed"><strong>What it is:</strong> Peer groups often contain one absurdly over-valued company (e.g., TSLA skewing automakers) or one bankrupt company. Taking the Mean (Average) breaks the math. The Median completely filters out extreme outliers to find the true market center.</p>
            </div>
          </div>
        </div>
